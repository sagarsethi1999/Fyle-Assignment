...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.getElementById('contactForm').addEventListener('submit', function (event) {
        ...
        fetch("https://getform.io/f/bpjmppzb", {
            method: "POST",
            body: formData,
            headers: {
...
const contentArray = [
    {
        imagePath: 'resources/images/project1.jpg',
    ...
    {
        imagePath: 'resources/images/image@2x.png',
        title: 'Better Strategy & Quality',
        description: 'Set to launch on the manufacturer\'s new A330neo aircraft in 2017, it\'s offering lots of'
    },
    {
        imagePath: 'resources/images/project2.jpeg',
        title: 'Genderless Kei - Japan\'s Hot',
        description: 'Set to launch on the manufacturer\'s new A330neo aircraft in 2017, it\'s offering lots of'
    }
];
